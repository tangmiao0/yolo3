...
def parse_data(line, class_num, img_size, anchors, mode, letterbox_resize):
    ...
    if not isinstance(line, list):
        ...
        # if r'F:\code\code--1\YOLOv3_TensorFlow-master\data\VOCdevkit\VOC2007\JPEGImages\000007.jpg'== pic_path:
        #     print('000')
...
def get_batch_data(batch_line, class_num, img_size, anchors, multi_scale=False, mix_up=False, letterbox_resize=True, interval=10, mode='train'):
    '''
...
if __name__ == "__main__":
    ...
    c = '1 ../data/VOCdevkit/VOC2007/JPEGImages/000007.jpg 500 333 6 141 50 500 330'
    a = get_batch_data([c], 20, [416, 416], args.anchors, interval=10)
    # a = cv2.imread('data/VOCdevkit/VOC2007/JPEGImages/000007.jpg')
    print(a)
